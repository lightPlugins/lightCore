...
dependencies {
    ...
    compileOnly(files("C:/Users/philipp/IdeaProjects/lightCoins/build/libs/lightCoins-1.0.0.jar"))
...
tasks {
    ...
    shadowJar {
        ...
        relocate("org.mariadb.jdbc", "io.lightstudios.core.util.libs.mariadb")
